...
/**
 Base class for all ASDI_Project4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ASDI_Project4 view hierarchy (such as wrapped iOS UIViews) was touched.
