...
// in simulator we redefine to format for ASDI_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.asdi_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.asdi_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIASDI_Project4NativeItemNone = -1, 
	UIASDI_Project4NativeItemSpinner = -2,
	UIASDI_Project4NativeItemProgressBar = -3,
	
	UIASDI_Project4NativeItemSlider = -4,
	UIASDI_Project4NativeItemSwitch = -5,
	UIASDI_Project4NativeItemMultiButton = -6,
	UIASDI_Project4NativeItemSegmented = -7,
	
	UIASDI_Project4NativeItemTextView = -8,
	UIASDI_Project4NativeItemTextField = -9,
	UIASDI_Project4NativeItemSearchBar = -10,
	
	UIASDI_Project4NativeItemPicker = -11,
	UIASDI_Project4NativeItemDatePicker = -12,
	
	UIASDI_Project4NativeItemInfoLight = -13,
	UIASDI_Project4NativeItemInfoDark = -14,
	
	UIASDI_Project4NativeItemDisclosure = -15,
	
	UIASDI_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ASDI_Project4 instances of
