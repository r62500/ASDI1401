...
/**
 The base class for all ASDI_Project4 modules
 */
...
/**
 ASDI_Project4 Platform calls this method on startup.
 */
-(void)startup;

/**
 ASDI_Project4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ASDI_Project4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ASDI_Project4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 ASDI_Project4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
