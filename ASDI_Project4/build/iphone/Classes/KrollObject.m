...
//@interface ASDI_Project4Object : NSObject
//@end

@interface ASDI_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ASDI_Project4Object class]])
		{
			for (NSString *key in [[(ASDI_Project4Object*)o modules] allKeys])
			{
