...
//Rare exceptions to indicate a bug in the _asdi_project4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ASDI_Project4 proxies.
 */
