...
@interface ASDI_Project4Object : KrollCoverageObject {
#else
@interface ASDI_Project4Object : KrollObject {
#endif
@private
...
extern NSString * ASDI_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ASDI_Project4Object *_asdi_project4;
    KrollObject* console;
	BOOL shutdown;
